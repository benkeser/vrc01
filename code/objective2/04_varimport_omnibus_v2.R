...
# ---------------------------------------------------------------------------- #
#
# source ("/home/cmagaret/compbio/projectus/cam101_nabResistanceScore/bin/02_analysis/varimport_omnibus_v2.R")
#
# ---------------------------------------------------------------------------- #
# ---------------------------------------------------------------------------- #
...
setwd (path.data)
data.analysis.all <- read.csv ("vrc01_final_r1_all_v11.csv", header=T)
